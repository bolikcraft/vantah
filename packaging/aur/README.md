...
`PKGBUILD` рядом ставит готовый бинарь из GitHub-релиза (`vantah-<ver>-linux-x64.tar.gz`),
не собирая проект из исходников — отсюда суффикс `-bin`. Имя `vantah` в AUR на момент
написания свободно, конфликтов нет.
